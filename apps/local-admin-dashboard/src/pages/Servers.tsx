  ...
  return (
    <div className="space-y-6">
      {!hideHeader && (
        <PageHeader
          title="MCP Servers"
          subtitle="Model Context Protocol servers registered on this device that AI apps can connect to."
          actions={
              ...
              servers.map((server) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    ...
                    >
                      <span
                        className={`h-1.5 w-1.5 rounded-full ${server.risk_level === "high" || server.risk_level === "critical" ? "bg-destructive" : server.risk_level === "medium" ? "bg-amber-500" : "bg-emerald-500"}`}
                      />
                      {server.risk_level}
                    </span>
                  </td>
