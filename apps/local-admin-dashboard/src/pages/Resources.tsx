            ...
            {loading ? (
              ...
              resources.map((resource) => (
                ...
                >
                  ...
                  <td
                    className="px-6 py-4 text-muted-foreground font-mono text-xs truncate max-w-[200px]"
                    title={resource.uri}
                  >
                    {resource.uri}
                  </td>
                  <td className="px-6 py-4">
                    ...
                    >
                      <span
                        className={`h-1.5 w-1.5 rounded-full ${resource.classification === "restricted" ? "bg-destructive" : resource.classification === "confidential" ? "bg-amber-500" : "bg-emerald-500"}`}
                      />
